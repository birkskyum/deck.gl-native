...
// Port of @luma.gl/shadertools/src/modules/lighting/phong-material/phong-shaders-wgsl.ts
// with `phongMaterial` renamed to `gouraudMaterial`, as the gouraudMaterial module does.

struct gouraudMaterialUniforms {
  unlit: u32,
  ambient: f32,
  diffuse: f32,
  shininess: f32,
