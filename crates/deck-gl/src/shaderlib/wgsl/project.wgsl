...
// Port of @deck.gl/core/src/shaderlib/project/project.wgsl.ts with the generated
// constant header expanded.

const COORDINATE_SYSTEM_DEFAULT: i32 = -1;
const COORDINATE_SYSTEM_LNGLAT: i32 = 1;
const COORDINATE_SYSTEM_METER_OFFSETS: i32 = 2;
const COORDINATE_SYSTEM_LNGLAT_OFFSETS: i32 = 3;
const COORDINATE_SYSTEM_CARTESIAN: i32 = 0;
const PROJECTION_MODE_WEB_MERCATOR: i32 = 1;
const PROJECTION_MODE_GLOBE: i32 = 2;
const PROJECTION_MODE_WEB_MERCATOR_AUTO_OFFSET: i32 = 4;
const PROJECTION_MODE_IDENTITY: i32 = 0;
const UNIT_COMMON: i32 = 0;
const UNIT_METERS: i32 = 1;
const UNIT_PIXELS: i32 = 2;
