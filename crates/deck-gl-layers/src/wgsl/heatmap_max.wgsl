// Port of @deck.gl/aggregation-layers/src/heatmap-layer/max.wgsl.ts: every vertex reduces a
// 16 x 16 block of the weights texture and the points are blended with max into one texel.
