// Port of @deck.gl/aggregation-layers/src/heatmap-layer/triangle-layer.wgsl.ts: draws the
// visible part of the weights texture, coloured through the colour range.
...
fn vertexMain(attributes: TriangleAttributes) -> TriangleVaryings {
  ...
  // Render target textures use a top left origin.
