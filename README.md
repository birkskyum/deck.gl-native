...
- `OrthographicView`, `OrbitView` and `FirstPersonView` next to the map view, with their viewports and view states, and an `OrbitController` (also for the orthographic view) with deck.gl's gestures
