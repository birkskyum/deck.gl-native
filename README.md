...
- `ScatterplotLayer`, `LineLayer`, `SolidPolygonLayer` (filled, extruded, wireframe, holes), `PathLayer` (joints, caps, billboard), `ArcLayer`, `BitmapLayer`, `IconLayer`, `ColumnLayer`, `PointCloudLayer`, and the composite `PolygonLayer` and `GeoJsonLayer`
