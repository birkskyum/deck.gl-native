...
| --- | ---: | ---: | ---: |
| `ScatterplotLayer` (function accessors) | 1,000,000 points | 17.6 ms | 2.6 ms |
| `ScatterplotLayer` (Arrow `Float32` positions, `UInt8` colours) | 1,000,000 points | 13.7 ms | 2.6 ms |
...
(uniform only) costs 4.3 ms and a fill colour accessor change 6.2 ms, against the full upload
above.
